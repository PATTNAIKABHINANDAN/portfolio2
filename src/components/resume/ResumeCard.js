  ...
  return (
    <div className='"w-full h-1/3 group flex'>
        <div className='w-10 h-[6px] bgOpacity mt-16 relative'>
            <span className='absolute w-5 h-5 rounded-full -top-2 -left-3 justify-center
            items-center bg-black bg-opacity-60'>
                <span className='w-3 h-3 -top-2 -left-3 rounded-full bg-bodyColor inline-flex group-hover:bg-designColor duration-300'></span>
            </span>
        </div>
        <div className='w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300
        rounded-lg px-10 flex flex-col justify-center gap-10'>
            <div className='flex justify-between items-center'>
                ...
                <div>
                    <p className='w-20 h-10 text-designColor bg-designColor bg-black bg-opacity-25 rounded-lg
                    flex justify-center items-center text-sm font medium'>{result}</p>
                </div>
            </div>
